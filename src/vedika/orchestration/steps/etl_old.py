# src/vedika/orchestration/steps/etl_old.py
...
from vedika.application.interfaces.repositories import BaseRawRepository, BaseUserRepository
...
def crawl_links(
    ...
    for url in tqdm(links, "Crawling links"):
        ...
        try:
            ...
            repository: BaseRawRepository = get_raw_repository(category=crawler._category)
            ...
            logger.exception(f"Failed to crawl and save {url=}:\n {e}")
